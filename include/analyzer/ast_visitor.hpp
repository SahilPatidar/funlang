...
class AstVisitor{
    ...
    virtual bool visit(const ForLoopState& astnode ){ return false; };
    ...
    virtual bool visit(const InState& astnode ){ return false; }
    ...
    virtual bool visit(const PostfixExper& astnode ){ return false; }
    virtual bool visit(const PrefixExper& astnode ){ return false; }
    virtual bool visit(const Parameter& astnode ){ return false; }
    
    virtual bool visit(const PointerType& astnode ){ return false; }
    virtual bool visit(const ArrayType& astnode ) { return false; };
    virtual bool visit(const FloatType& astnode ){ return false; };
    virtual bool visit(const StringType& astnode ){ return false; }
    virtual bool visit(const Identifier& astnode ){ return false; }
    virtual bool visit(const IntType& astnode ){ return false; }
    virtual bool visit(const BoolType& astnode ){ return false; }
